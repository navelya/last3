...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.section 
        id="section-1763152570962-kls7xlu"
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">Transform Your Workflow</h1>
      ...
      <motion.section 
        id="section-1763152570962-y7y2jj2"
      ...
      <motion.section 
        id="section-1763152570962-5fu7ip7"
        className="py-16 text-center px-4"
      ...
      <motion.section 
        id="section-1763152570962-x160hl3"
      ...
      <motion.section 
        id="section-1763152570962-oihzunw"
